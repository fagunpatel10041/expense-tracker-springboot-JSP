		...
		<nav class="navbar navbar-expand-lg custom-navbar">
			...
			<div class="collapse navbar-collapse" id="retailAdminNavbar">
				<ul class="navbar-nav m-auto">
					<li class="nav-item"><a class="nav-link active-page" href="${pageContext.request.contextPath}/dashboard">
				...
				<div class="row gutters">
					...
					<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
						<div class="card">
							<div class="card-body">
								<form:form
									action="${pageContext.request.contextPath}/expenses/processUpdateExpense"
									method="POST" modelAttribute="theExpense">
									<div class="row gutters">
										<div class="col-xl-4 col-lglg-4 col-md-4 col-sm-4 col-12">
											<div class="form-group">
												...
												<form:select path="category.id"  class="form-control">
													...
													<c:forEach var="categories" items="${theListCategory}">
										...
										<div class="col-xl-4 col-lglg-4 col-md-4 col-sm-4 col-12">
											<div class="form-group">
												<label for="inputEmail">Date of Expense</label> 
												<form:input type="date" path="expenseDate" class="form-control"/>
											</div>
										</div>
										<div class="col-xl-4 col-lglg-4 col-md-4 col-sm-4 col-12">
											<div class="form-group">
												<label for="inputPwd">Expense Item Name -> ${theExpense.id}</label> 
												<form:input type="text" path="expenseItem" class="form-control" 
													placeholder="Expense Item"/>
											</div>
										</div>
										<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
											<div class="form-group">
												<label for="inputReadOnly">Cost of Expense</label>
												<div class="input-group">
													<div class="input-group-prepend">
														<span class="input-group-text">$</span> <span
															class="input-group-text">0.00</span>
													</div>
													<form:input type="text" path="expenseCost" class="form-control"
														aria-label="Dollar amount (with dot and two decimal places)"/>
												</div>
											</div>
										</div>
										
										<!-- Hidden values for expense id and userid -->
										<form:hidden path="id"/>
										<form:hidden path="userId"/>
										
										
									</div>
									<button type="submit" class="btn btn-primary mb-1">Add
										Expense</button>
								</form:form>
							</div>
						</div>
