			...
			<div class="collapse navbar-collapse" id="retailAdminNavbar">
				<ul class="navbar-nav m-auto">
					...
					<li class="nav-item dropdown"><a
						class="nav-link dropdown-toggle  active-page" href="#"
				...
				<div class="row gutters">
					...
					<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
						<div class="card">
							<div class="card-body">
								<form:form
									action="${pageContext.request.contextPath}/expenses/processAddExpense"
									...
									<div class="row gutters">
										<div class="col-xl-4 col-lglg-4 col-md-4 col-sm-4 col-12">
											<div class="form-group">
												...
												<form:select path="category.id" class="form-control">
													...
													<c:forEach var="categories" items="${theCategory}">
										...
										<div class="col-xl-4 col-lglg-4 col-md-4 col-sm-4 col-12">
											<div class="form-group">
												<label for="inputPwd">Expense Item Name</label> 
