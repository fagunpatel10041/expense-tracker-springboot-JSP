				...
				<div class="row gutters">
					...
					<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
						<div class="card">
							<div class="card-body">
								<form:form
									action="${pageContext.request.contextPath}/user/processUpdateProfile"
									method="POST" modelAttribute="theUser">
									<div class="row gutters">
										...
										<div class="col-xl-4 col-lglg-4 col-md-4 col-sm-4 col-12">
											...
											<%-- <input type="text" name="roles" value='<security:authentication property="principal.authorities[0]"/>' /> --%>
										</div>
